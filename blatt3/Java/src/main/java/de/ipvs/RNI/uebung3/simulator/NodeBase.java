...
/**
 * Base functionality for a node. This class does not implement any routing functionality, and
...
public abstract class NodeBase {
    ...
    public Enumeration<Link> getInterfaces() {
    ...
    private int address;
    /**
     * A table of routes, maintained by init, interfaceUp, interfaceDown, and receivePacket.
     */
    protected RoutingTable routingTable;
    /**
     * A table of interfaces. The node never needs to change these directly.
     */
    protected Vector<Link> interfaces;
}
